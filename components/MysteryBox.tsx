  ...
  return (
    <>
      ...
      >
          ...
          <span className="mt-1.5 bg-zinc-50 dark:bg-zinc-900/90 backdrop-blur-md px-2.5 py-0.5 rounded text-[9px] font-semibold  tracking-normal text-purple-900 shadow-sm border border-purple-100">Mystery Box</span>
      </motion.div>
          ...
          >
            ...
            >
              ...
              {result === 'win' && revealedProduct ? (
                <>
                  <div className="inline-block px-3 py-1 bg-purple-100 text-purple-600 rounded-full text-[9px] font-semibold  tracking-normal mb-6">
                    You Unlocked a Deal!
                  </div>
