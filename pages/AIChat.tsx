      ...
      <div className="glass sticky top-0 z-50 px-6 py-5 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col">
            <h2 className="font-semibold text-xs  tracking-normal">
              Vibe AI Assistant
            </h2>
            <div className="flex items-center text-[8px] font-bold text-green-500  tracking-normal mt-1">
              <span className="w-1.5 h-1.5 bg-green-500 rounded-full mr-2 animate-pulse"></span>
              Online
            </div>
          </div>
        </div>
        <div className="flex bg-zinc-50 dark:bg-zinc-800 p-1 rounded-full border border-zinc-100 dark:border-zinc-800">
          <button
            onClick={() => setUseThinking(!useThinking)}
            className={`px-4 py-2 rounded-full text-[9px] font-semibold  tracking-normal transition-all ${useThinking ? "bg-zinc-900 text-white shadow-md" : "text-zinc-400"}`}
          >
            AI Expert Mode
          </button>
        </div>
