  ...
  return (
    <div className="p-6 md:p-12 pb-48 bg-zinc-50 dark:bg-zinc-800 max-w-2xl mx-auto min-h-screen font-inter">
      <div className="flex items-center space-x-6 mb-12">
        <button
          onClick={() => navigate(-1)}
          className="w-12 h-12 flex items-center justify-center bg-zinc-50 dark:bg-zinc-800 rounded-full border border-zinc-100 dark:border-zinc-800 shadow-sm hover:bg-zinc-900 dark:bg-zinc-100 hover:text-white transition-all active:scale-95"
        >
        ...
        <div className="flex flex-col">
          ...
          <p className="text-[10px] font-bold text-zinc-800 dark:text-zinc-200/70  tracking-normal mt-1 pr-2">
        ...
        <div className="flex flex-col items-center justify-center mb-10">
          <div className="relative mb-4">
            ...
            <button
              ...
              disabled={updating}
              className="absolute bottom-1 right-1 w-8 h-8 bg-zinc-900 dark:bg-zinc-100 text-white rounded-full flex items-center justify-center hover:bg-[#0a4a2b] shadow-md transition-all active:scale-95"
            >
        ...
        <form onSubmit={handleUpdate} className="space-y-6">
          ...
          <div className="pt-4">
            <button
              disabled={updating}
              type="submit"
              className="w-full py-4 bg-zinc-900 dark:bg-zinc-100 text-white rounded-full font-bold text-xs  tracking-normal shadow-lg shadow-[#06331e]/20 hover:bg-[#0a4a2b] transition-all active:scale-[0.98] disabled:opacity-50"
            >
