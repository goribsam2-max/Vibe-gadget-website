  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-10 pb-32 min-h-screen bg-zinc-50 dark:bg-zinc-800 font-inter">
      <div className="flex items-center space-x-6 mb-10">
        ...
        <div>
          <h1 className="text-lg font-semibold tracking-tight text-zinc-900 dark:text-zinc-100 mb-1">
            Ticket Details
          </h1>
          <p className="text-zinc-400 text-[10px] font-bold tracking-normal ">
            #{ticket.id.slice(0, 8)}
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-zinc-50 dark:bg-zinc-800 p-6 rounded-2xl border border-zinc-100 dark:border-zinc-800 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            ...
            <span
              className={`px-3 py-1 rounded-full text-[9px] font-bold  tracking-normal ${ticket.status === "Open" ? "bg-orange-100 text-orange-600" : ticket.status === "Replied" ? "bg-blue-100 text-blue-600" : ticket.status === "Resolved" ? "bg-emerald-100 text-zinc-800 dark:text-zinc-200" : "bg-zinc-200 text-zinc-600 dark:text-zinc-400"}`}
            >
              {ticket.status}
            </span>
          </div>
              ...
              {ticket.feedback ? (
                ...
                <div className="flex gap-3 justify-center">
                  <button
                    ...
                    className="flex-1 py-3 bg-zinc-50 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 border border-emerald-200 hover:bg-emerald-600 hover:text-white rounded-full font-bold text-[10px]  tracking-normal transition-colors flex items-center justify-center"
                  >
