  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 pb-40 animate-fade-in min-h-screen bg-zinc-50 dark:bg-zinc-800">
      <div className="flex items-center space-x-5 mb-14">
        <button
          onClick={() => navigate(-1)}
          className="w-10 h-10 flex items-center justify-center bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 rounded-full hover:bg-zinc-900 hover:text-white transition-all active:scale-95"
        >
          <Icon name="arrow-left" className="text-xs" />
        </button>
        <div>
          <h1 className="text-lg md:text-xl lg:text-base xl:text-sm font-bold tracking-tight text-zinc-900 dark:text-zinc-100 mb-0.5">
            My Orders
          </h1>
          <p className="text-zinc-500 text-[11px] font-medium tracking-normal ">
            Purchase History
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-40 flex flex-col items-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-8 py-3.5 bg-primary-500 text-white rounded-full text-[10px] font-bold  tracking-normal shadow-md hover:bg-zinc-800 transition-all"
          >
            Start Shopping
          </button>
        </div>
          ...
          {orders.map((order, index) => {
            ...
            if (recent) {
              return (
                ...
                >
                  <div className="absolute top-0 left-8 bg-primary-500 text-white text-[9px] font-bold  tracking-normal px-4 py-1.5 rounded-b-lg">
                    Latest Order
                  </div>
                  ...
                  <div className="flex justify-between items-end pt-6 border-t border-zinc-100 dark:border-zinc-800">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <button className="w-10 h-10 bg-primary-500 text-white rounded-full flex items-center justify-center group-hover:scale-105 transition-transform">
