          ...
          <div className="flex space-x-3">
            {["seo", "taxes", "bulk"].includes(pathBase) ? (
              <button
                ...
                className="bg-zinc-900 dark:bg-zinc-100 text-white px-6 py-2.5 rounded-full text-xs font-bold tracking-normal  hover:bg-emerald-900 transition-colors shadow-md"
              >
