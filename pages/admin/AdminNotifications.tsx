        ...
        <form onSubmit={handleSendNotification} className="space-y-6">
          ...
          <div className="pt-4">
            <button
              disabled={loading}
              type="submit"
              className="w-full py-4 bg-zinc-900 dark:bg-zinc-100 text-white rounded-full font-bold text-xs  tracking-normal shadow-lg shadow-[#06331e]/20 hover:bg-[#0a4a2b] transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center space-x-3"
            >
