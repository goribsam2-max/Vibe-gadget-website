    ...
    <div className="max-w-4xl mx-auto px-6 py-10 pb-32 min-h-screen bg-zinc-50 dark:bg-zinc-800">
      <div className="flex items-center space-x-6 mb-12">
        <button
          ...
          className="w-12 h-12 flex items-center justify-center bg-red-50 border border-red-100 text-red-500 rounded-full shadow-sm hover:bg-red-500 hover:text-white transition-all active:scale-95"
        >
            ...
            >
              ...
              <div className="flex items-center space-x-4 pt-6 border-t border-red-100/50">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 hover:text-zinc-900 dark:text-zinc-100 hover:border-emerald-200 rounded-full text-[9px] font-semibold  tracking-normal transition-all shadow-sm"
                >
                  Mark as Safe
                </button>
              </div>
