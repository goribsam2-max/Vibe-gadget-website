                  ...
                  >
                    ...
                    <td className="p-5 align-top">
                      <div className="flex flex-col space-y-2">
                        ...
                        {t.feedback && (
                          <span
                            className={`inline-flex w-fit items-center px-2.5 py-1 rounded text-[10px] font-bold border ${t.feedback === "Satisfied" ? "bg-emerald-100 text-emerald-700 border-emerald-200" : "bg-red-100 text-red-700 border-red-200"}`}
                          >
                            <Icon
                              name={
                    ...
                    <td className="p-5 align-top">
                      <span
                        className={`px-3 py-1.5 rounded-full text-[9px] font-bold  tracking-normal ${t.status === "Open" ? "bg-orange-100 text-orange-600" : t.status === "Replied" ? "bg-blue-100 text-blue-600" : t.status === "Resolved" ? "bg-emerald-100 text-zinc-800 dark:text-zinc-200" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-500"}`}
                      >
                        {t.status || "Open"}
                      </span>
                    </td>
                        ...
                        <div className="w-full max-w-4xl">
                          ...
                          <div className="flex justify-end">
                            <button
                              ...
                              className="px-8 py-3 bg-zinc-900 dark:bg-zinc-100 text-white rounded-full font-bold text-xs  tracking-normal shadow-lg hover:bg-zinc-900 transition-all"
                            >
                              Send Reply
                            </button>
                          </div>
