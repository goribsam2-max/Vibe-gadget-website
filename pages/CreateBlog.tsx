  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 pb-32 min-h-screen bg-zinc-50 dark:bg-zinc-800 font-inter">
      <div className="flex items-center space-x-4 mb-8">
        <button
          onClick={() => navigate(-1)}
          className="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-900 hover:text-white transition-colors"
        >
            ...
            <div className="bg-zinc-50 dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700 flex flex-wrap items-center p-2 gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="px-3 py-1.5 bg-zinc-50 dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 hover:bg-emerald-100 rounded-md text-xs font-bold flex items-center gap-1"
                >
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-800 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-700 space-y-4">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="w-full py-4 mt-4 bg-primary-500 text-white rounded-full text-xs font-bold  tracking-normal hover:bg-zinc-800 transition-colors shadow-lg active:scale-95"
            >
